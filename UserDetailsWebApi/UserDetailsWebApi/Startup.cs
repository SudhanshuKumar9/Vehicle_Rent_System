...
namespace AuthenticateApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //{
            //    options.AddPolicy("UserRolePolicy", policy => policy.RequireClaim("User"));

            //});
            services.AddDbContext<UserContext>(option => option.UseSqlServer(Configuration.GetConnectionString("UserDB")));
